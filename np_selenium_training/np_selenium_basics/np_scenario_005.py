...
print("Automating dropdown and click action.")

country_drop_down=driver.find_element(By.ID,"country")#finding the dropdown menu
country_drop_down.send_keys("F")#entering the country name which is present in dropdown menu