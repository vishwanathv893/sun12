...
c_alert_button=driver.find_element(By.ID,"confirmBtn")#finding the confirmation button
c_alert_button.click()#click on  confiramtion alert button
time.sleep(2)

driver.switch_to.alert.accept()#click on "ok" on pop up button

#driver.switch_to.alert.dismis()#using dismiss button